package com.example.gestion_produit.event;
...
import com.example.gestion_produit.event.TopEventsAdapter;
import com.example.gestion_produit.front.GitHubService;
import com.example.gestion_produit.model.Event;
import com.example.gestion_produit.model.TopEvents;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // API call
        Call<List<Event>> call = blogApi.getAllevent();
